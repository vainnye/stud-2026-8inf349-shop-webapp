...
**en full local**
```powershell
$env:API_PRODUCTS_FILE="./res/data/products.json"; $env:API_USE_MOCKS="True"; $env:FLASK_APP="shop_webapp"; flask run --debug;
```

**si t'as de la connexion internet**
```powershell
$env:API_PRODUCTS_FILE=""; $env:API_USE_MOCKS="False"; $env:FLASK_APP="shop_webapp"; flask run --debug;
```
